...
if __name__ == '__main__':
    ...
    hParams_MVG = Gau_MVG_ML_estimates(DTR, LTR)
    LLR = logpdf_GAU_ND(DVAL, hParams_MVG[2][0], hParams_MVG[2][1]) - logpdf_GAU_ND(DVAL, hParams_MVG[1][0],
                                                                                    hParams_MVG[1][1])
    ...
    hParams_Tied = Gau_Tied_ML_estimates(DTR, LTR)
    LLR = logpdf_GAU_ND(DVAL, hParams_Tied[2][0], hParams_Tied[2][1]) - logpdf_GAU_ND(DVAL, hParams_Tied[1][0],
                                                                                      hParams_Tied[1][1])
