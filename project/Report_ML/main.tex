...
\end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{.3\textwidth}
            ...
            % Rimuovi la caption e l'etichetta da qui
        \end{minipage}
        \caption{Binary Logistic Regression Model with prior-weighted \(\pi_T=0.1\)} % Aggiungi una caption unica qui
...
\begin{table}[H]
    ...
    \textbf{\(10^{-4}\)} &  \textcolor{red}{0.363975} & \textcolor{red}{0.402089} \\
    \textbf{\(10^{-3}\)} & 0.364967 & 0.413002 \\
    \textbf{\(10^{-2}\)} & 0.361143 & 0.413002 \\
    ...
    \textbf{\(10^{-1}\)} & 0.398842 & 0.780898\\\hline\hline
    \multicolumn{3}{c}{\textbf{Binary Logistic Regression with prior-weighted \(\pi_T=0.1\)}} \\   \hline
    \textbf{\(10^{-4}\)} & 0.372056 & 0.672763\\
    \textbf{\(10^{-3}\)} & 0.369928 & 0.709469\\
    \textbf{\(10^{-2}\)} & 0.362983 & 0.890873\\
    \textbf{\(10^{-1}\)} & 0.364823  & 1.0\\\hline\hline
...
\begin{table}[H]
    ...
    \textbf{\(10^{-1}\)} &  0.246607 & 0.751984 \\\hline\hline
