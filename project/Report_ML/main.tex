...
We have considered different types of applications with various priorities (\( \tilde{\pi}\)), while the cost of different types of errors \((C_fn,C_fp)\) are always considered the same in all applications i.e., they will be set at 1.0. The target application chosen to be balanced will be:
\begin{equation}
