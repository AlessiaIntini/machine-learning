...
\begin{figure}[H]
    ...
    \label{fig:GMM_hist} 
\end{figure}
We can see that the number of components that gives the best results are 4 and 8, both in the case of full covariance and diagonal covariance.
\begin{table}[H]
    \centering
    \begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{3cm}>{\centering\arraybackslash}m{2cm}}
    \hline
    \multicolumn{3}{c}{\textbf{GMM model }} \\   \hline
    \textbf{nComponents}  &  \textbf{minDCF} & \textbf{actDCF} \\ \hline
    \multicolumn{3}{c}{\textbf{Full cov }} \\   \hline
    \textbf{\(4\)} & 0.216141 & 0.239535\\
    \textbf{\(8\)} & 0.178603 & 0.192764\\
    \textbf{\(16\)} & 0.163130 & 0.176603 \\
    \textbf{\(32\)} & 0.233726 & 0.249888\\\hline\hline
    \multicolumn{3}{c}{\textbf{Diag cov }} \\   \hline
    \textbf{\(4\)} & 0.148105 & 0.168666 \\
    \textbf{\(8\)} & \textcolor{red}{0.146265} & 0.180859\\
    \textbf{\(16\)} & 0.162154  & 0.176891\\
    \textbf{\(32\)} & 0.176619 & 0.198860\\
    \hline
    \end{tabular}
    \caption{minDCF and actDCF}
    \label{tab:GMM}
...
\begin{itemize}
    \item  After applying the model we can conclude that the best performance is achieved by using 8 components for both classes, this suggests that these components are sufficient to capture the complexity and variance of the data without incurring overfitting or underfitting.\\
...
\begin{itemize}
    \item \textbf{GMM with diag covariance} with \(nComponents=8\)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{GMM:} GMM with Diag covariance \(nComponents=8\), Best minDCF 0.146265
\end{itemize}
\begin{figure}[H]
    \centering
    \begin{minipage}{.3\textwidth}
